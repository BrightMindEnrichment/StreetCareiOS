//
//  ChangesEventDataAdapter.swift
//  StreetCare
//
//  Created by Amey Kanunje on 12/23/24.
//
...
protocol ChangesEventDataAdapterProtocol {
...
class ChangesEventDataAdapter {
    
    var events = [Event]()
    var helpRequests = [HelpRequest]()
    var outreachEvents: [Event] = []
    var delegate: ChangesEventDataAdapterProtocol?
...
//                
//                try await sendHelpRequestGeocodeAddress(title: title, description: description, addressSet: addressSet)
//                
//            }
//            
//            func sendHelpRequestGeocodeAddress(title: String, description: String?, addressSet: Set<String>) async throws{
//                
//                var geocodingTasks: [Task<CLLocationCoordinate2D, Error>] = []
//                
//                for address in addressSet{
//                    //print("AddressSet Data -> \(address)")
//                    let task = Task{
//                        try await self.geocodeAddress(address)
//                    }
//                    geocodingTasks.append(task)
//                }
//                
...
//                        )
//                        mapOutreachEvents.append(event)
//                    }catch{
//                        print("Geocoding Task Error \(error.localizedDescription)")
//                        throw error
//                    }
//                }
//                print("mapOutreachEvents count = \(mapOutreachEvents.count)")
//            }
//        
